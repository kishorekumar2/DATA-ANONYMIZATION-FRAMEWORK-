...
config = {
  "apiKey": "AIzaSyAyzjO93nqJ-xcQh0sYaQHBa4G8BUBuPJ0",
  "authDomain": "data-anonymiaztion.firebaseapp.com",
  "databaseURL": "https://data-anonymiaztion-default-rtdb.firebaseio.com/",
  "storageBucket": "data-anonymiaztion.appspot.com"
}
...
def login():
    ...
    try:
        ...
        return render_template('login_register.html', login_error=login_error)

# Flask route for register
...
def register():
    ...
    if new_password != confirm_password:
        ...
        return render_template('login_register.html', register_error=register_error)
    ...
    try:
        ...
        register_error = "Error occurred while registering. Please try again."
        return render_template('login_register.html', register_error=register_error)

# Sample dashboard route after successful login/register
...
# Sample index route to render the HTML template
@app.route('/')
def index():
